    ...
    <View style={styles.confirmWrap}>
      <View style={styles.confirmBox}>
        ...
        <ScrollView style={styles.content}>
          ...
          <View style={{ marginTop: 17, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', flexWrap: 'wrap' }}>
            <Text style={styles.message2}> 1、我们将通过</Text>
            <Pressable onPress={() => WebBrowser.openBrowserAsync(AGREEMENT_H5.USER)}>
              <Text style={[styles.message2, { color: '#24a7f5' }]}>《用户协议》</Text>
            </Pressable>
            <Text>和</Text>
            <Pressable onPress={() => WebBrowser.openBrowserAsync(AGREEMENT_H5.PRIVACY)}>
              <Text style={[styles.message2, { color: '#24a7f5' }]}>《隐私政策》</Text>
            </Pressable>
